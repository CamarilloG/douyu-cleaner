...
(function () {
    ...
    const css = `
        ...
        /* 原生 setting 浮层：让它向上弹出（默认是向下），并控制 z-index 不被裁剪 */
        ...
        /* 防止 controlbar overflow:hidden 把浮层裁掉（如果有） */
    ...
    const mount = async () => {
        ...
        console.log('[Douyu Cleaner] v2.3 shell mounted');
    };
    const unmount = () => {
        stopLatencyChase();
    ...
    console.log('[Douyu Cleaner] v2.3.0 已加载');
})();
