...
(function () {
    ...
    const css = `
        ...
        /* 弹幕：完全不干预样式。
           我们 reparent 整个 #js-player-video-case，飞行弹幕容器/特效层/
           尺寸自适应/样式全部由原生 React 管理，避免 CSS 变量驱动引发的
           "弹幕消失/字号错乱/速度跳帧"等问题。 */
    ...
    const mount = async () => {
        ...
        console.log('[Douyu Cleaner] v2.4 shell mounted');
    };
    const unmount = () => {
        stopLatencyChase();
    ...
    console.log('[Douyu Cleaner] v2.4.0 已加载');
})();
